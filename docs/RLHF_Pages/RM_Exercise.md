...
<iframe src="/AIDIY/RLHF_Pages/RM_Exercise_viz.html" width="100%" height="600px" style="border: 1px solid #ccc;" title="RM Exercise Interactive Content">
    您的浏览器不支持 iframe，无法加载交互式内容。
    请 <a href="/AIDIY/RLHF_Pages/RM_Exercise_viz.html" target="_blank">点击这里在新窗口中查看</a>。
</iframe>
